...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    GENERRATE_WITH_LYRICS: process.env.GENERRATE_WITH_LYRICS,
    ...
    AWS_SECRET_ASCESS_KEY_ID: process.env.AWS_SECRET_ASCESS_KEY_ID,
